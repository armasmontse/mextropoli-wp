...
<?php if ( $query->have_posts() ) : ?>
    ...
    <div class="loop-expositores__contenedor">
        ...
        <?php  while ( $query->have_posts() ) : $query->the_post(); $i++; ?>
            <div class="loop-expositores__card modalOpen" style="background-image: url('<?php echo get_the_post_thumbnail_url(); ?>');" data-index="modal-<?php echo $i;?>" data-name="<?php the_title(); ?>" id="<?php the_title(); ?>">
